const countriesData = [
    ...
    },
    {
        ...
        "cities": ['Ampara', 'Anuradhapura', 'Badulla', 'Batticaloa', 'Colombo', 'Galle', 'Gampaha', 'Hambantota', 'Jaffna', 'Kalutara', 'Kandy', 'Kegalle', 'Kilinochchi', 'Kurunegala', 'Mannar', 'Matale', 'Matara', 'Monaragala', 'Mullativu', 'Nuwara Eliya', 'Polonnaruwa', 'Puttalam', 'Ratnapura', 'Trincomalee', 'Vavuniya']
    },
    {
        "country": "Sudan",
        "alpha2Code": "SD",
...
export function getCountries(): string[] {
    return countriesData.map(obj => obj.country);
}

export function getStates(country: string): string[] | undefined {
    const selectedCountry = countriesData.find(obj => obj.country === country);
    return selectedCountry ? selectedCountry.states : [];
}

export function getCities(country: string): string[] | undefined {
    const selectedCountry = countriesData.find(obj => obj.country === country);
